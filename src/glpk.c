...
int c_glp_solve_internal (glp_prob *lp) {
    return glp_interior(lp, NULL);
}

int c_glp_get_status (glp_prob *lp) {
    return glp_get_status (lp);
}

int c_glp_get_prim_stat (glp_prob *lp) {
    return glp_get_prim_stat (lp);
}

int c_glp_get_dual_stat (glp_prob *lp) {
    return glp_get_dual_stat (lp);
}

int c_glp_ipt_status (glp_prob *lp) {
...
double c_glp_ipt_obj_val(glp_prob *lp){
...
double c_glp_get_col_dual(glp_prob *lp, int i){
  	return glp_get_col_dual(lp, i);
}

double c_glp_get_row_dual(glp_prob *lp, int i){
  	return glp_get_row_dual(lp, i);
}

double c_glp_ipt_col_prim(glp_prob *lp, int i){
  	return glp_ipt_col_prim(lp, i);
}

double c_glp_ipt_col_dual(glp_prob *lp, int i){
  	return glp_ipt_col_dual(lp, i);
}
...
int c_glp_get_num_nz (glp_prob *lp){
